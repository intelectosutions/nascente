...
import { getBalanceByPropertyId } from "@/lib/balance";
...
export default async function PainelFazenda({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Fazenda com lista individual usa planilha; as demais usam saldo manual.
  ...
  return (
    <div className="flex flex-col gap-6 pb-12">
      ...
      {usaPlanilha ? (
        ...
        <BalanceForm slug={slug} initial={initialBalance} />
      )}
    </div>
  );
}
